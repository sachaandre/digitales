...
ActiveRecord::Schema.define(version: 20170412135101) do
  ...
  create_table "aventures", force: :cascade do |t|
    ...
    t.index ["country_id"], name: "index_aventures_on_country_id", using: :btree
  end
  ...
  add_foreign_key "aventures", "countries"
end
